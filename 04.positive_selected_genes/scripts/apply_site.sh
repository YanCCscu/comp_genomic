...
cat <<EOF > site.M0M1M2M3M7M8.ctl
     seqfile = $inphy            * sequence data file name
    treefile = $intree     * tree structure file name
     outfile = ${inphy%.*}_M0M1M2M3M7M8.mlc      * main result file name-----
...
cat <<EOF > site.M8a.ctl
     seqfile = $inphy               * sequence data file name
    treefile = $intree        * tree structure file name
     outfile = ${inphy%.*}_M8a.mlc  * main result file name--------------
...
$toolsdir/codeml site.M0M1M2M3M7M8.ctl
mv rst site.M0M1M2M3M7M8.rst
$toolsdir/codeml site.M8a.ctl
mv rst site.M8a.rst

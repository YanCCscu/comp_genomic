#!/bin/bash
#do episodic positive selection test with codeml branch model
...
$toolsdir/codeml branch.nul.ctl
mv rst branch.nul.rst
$toolsdir/codeml branch.alt.ctl
mv rst branch.alt.rst
